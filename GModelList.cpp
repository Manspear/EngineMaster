...
void GModelList::initializeModels(ID3D11Device* gDevice, ID3D11DeviceContext * gDeviceContext) {
	...
	this->modelList[0].load(".\\Objects/itsBoxxyTextured2.fbx", gDevice, gDeviceContext, NULL, L"./Images/normal_map.jpg");
	//this->modelList[0].load(".\\Objects/box2.fbx", gDevice, gDeviceContext, NULL, L"./Images/normal_map.jpg");
	
	//this->modelList[2].loadBlendShape(".\\Objects/erect.fbx", ".\\Objects/slakuvd.fbx", gDevice, gDeviceContext, L"./Images/TestPink.jpg", L"./Images/normal_4.png");
	...
	modelList[0].setPosition(XMFLOAT4(-1, 0, 0, 1), gDeviceContext);
