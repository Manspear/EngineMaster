...
void GModelList::initializeModels(ID3D11Device* gDevice, ID3D11DeviceContext * gDeviceContext) {
	...
	//this->modelList[3].load(".\\Objects/lambertCube.fbx", gDevice, gDeviceContext, L"./images/Chesterfield_texture.jpg", L"./Images/normal_map.jpg");
	...
	//modelList[3].setPosition(XMFLOAT4(0, 0, 0, 1), gDeviceContext);
	modelList[0].DCMcheck = true;
}
